...
library(zoo)
library(ggpubr)
filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH1/postProcessing/surfaceElevation/0/surfaceElevation.dat"
MESH1 = read.table(filenames[1],header = TRUE)
gauge_pos <- MESH1[c(1,2,3),]
MESH1 <- MESH1[-c(1,2,3,4),]
rownames(MESH1) <- NULL

filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH2/postProcessing/surfaceElevation/0/surfaceElevation.dat"
MESH2 = read.table(filenames[1],header = TRUE)
MESH2 <- MESH2[-c(1,2,3,4),]
rownames(MESH2) <- NULL

filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH3/postProcessing/surfaceElevation/0/surfaceElevation.dat"
...
filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH5/postProcessing/surfaceElevation/0/surfaceElevation.dat"
MESH5 = read.table(filenames[1],header = TRUE)
MESH5 <- MESH5[-c(1,2,3,4),]
rownames(MESH5) <- NULL

filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH6/postProcessing/surfaceElevation/0/surfaceElevation.dat"
MESH6 = read.table(filenames[1],header = TRUE)
MESH6 <- MESH6[-c(1,2,3,4),]
rownames(MESH6) <- NULL

filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH7/postProcessing/surfaceElevation/0/surfaceElevation.dat"
MESH7 = read.table(filenames[1],header = TRUE)
MESH7 <- MESH7[-c(1,2,3,4),]
rownames(MESH7) <- NULL

filenames = "/home/george/OpenFOAM/george-v1912/run/R14NA_MESH8/postProcessing/surfaceElevation/0/surfaceElevation.dat"
